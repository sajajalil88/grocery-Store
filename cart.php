...
if(isset($_GET['delete'])){
   ...
   $delete_cart_item = mysqli_fetch_assoc($conn,"DELETE FROM `cart` WHERE id = '$delete_id'");
...
if(isset($_POST['update_qty'])){
   ...
   $p_qty = $_POST['p_qty'];
   $update_qty = mysqli_query($conn,"UPDATE `cart` SET quantity = '$p_qty' WHERE id = '$cart_id'");
